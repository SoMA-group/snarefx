...
#from deepafx.jakes_model import Networks
...
#    if encoder == 'jakes':
#        networks = Networks(input_shape=(x.shape[1],x.shape[2],x.shape[3]), n_params=dafx_params)
#        encoder_model = networks.C
