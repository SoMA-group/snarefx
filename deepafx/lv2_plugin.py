...
class LV2_Plugin:
    ...
    def __init__(self, plugin_uri, sr, hop_samples=22050, verbose=False, mono=False):
...
class LV2_Plugin_Chain:
    ...
    def __init__(self, plugin_uri_list, stereo_list, sr, hop_samples=22050, verbose=False):
        """Constructor that creates the internal LV2 C++ object.
